            ...
            <div className="addAccount__list">
              <div className="addAccount__items">
                <div className="addAccount__item">
                  ...
                  <input type="text" placeholder="Nhập họ tên" className="addAccount__input" />
                </div>
                <div className="addAccount__item">
                  <p className="addAccount__item__title">Tên đăng nhập:<span>*</span></p>
                  <input type="text" placeholder="Nhập tên đăng nhập" className="addAccount__input" />
                </div>
              </div>
              <div className="addAccount__items">
                <div className="addAccount__item">
                  <p className="addAccount__item__title">Số điện thoại <span>*</span></p>
                  <input type="text" placeholder="Nhập số điện thoại" className="addAccount__input" />
                </div>
                <div className="addAccount__item">
              ...
              <div className="addAccount__items">
                <div className="addAccount__item">
                  ...
                  <input type="text" placeholder="Nhập địa chỉ Email" className="addAccount__input" />
                </div>
                <div className="addAccount__item">
